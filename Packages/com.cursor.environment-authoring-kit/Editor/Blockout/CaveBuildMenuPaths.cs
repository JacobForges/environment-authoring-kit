namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveBuildMenuPaths
    {
        ...
        public const string SnapSurfaceTerrainGrid =
            Advanced + "Snap Surface Terrain Grid (Active Scene)";
        public const string ExpandOpenWorldTerrainRing =
            Advanced + "Expand Open World — Add Next Terrain Ring";
        ...
        public const string DemoRecordingPreset = CaveBuild + "Demo Recording Preset (MacBook + paced)";
