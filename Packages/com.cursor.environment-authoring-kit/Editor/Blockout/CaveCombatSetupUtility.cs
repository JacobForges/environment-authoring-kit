...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveCombatSetupUtility
    {
        ...
        {
            var cc0 = BiomeEnemyCombatAuthor.PrefabForCave();
            if (cc0 != null)
                return cc0;
        ...
        static GameObject BuildEnemyRoot()
        {
            ...
            if (go.GetComponent<CaveSpawnedEnemyAdapter>() == null)
                go.AddComponent<CaveSpawnedEnemyAdapter>();
        ...
        static void UpgradePrefabIfNeeded(GameObject prefabRoot)
        {
            ...
            if (instance.GetComponent<CaveSpawnedEnemyAdapter>() == null)
            {
                instance.AddComponent<CaveSpawnedEnemyAdapter>();
                changed = true;
            }
        ...
        public static int WireSceneCombat(Transform caveRoot = null)
        {
            ...
            if (player != null && player.GetComponent<PickaxeTool>() == null)
            {
                player.AddComponent<PickaxeTool>();
                EditorUtility.SetDirty(player);
                wired++;
            }
