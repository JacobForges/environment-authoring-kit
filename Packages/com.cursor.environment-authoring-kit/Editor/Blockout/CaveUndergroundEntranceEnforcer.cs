...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveUndergroundEntranceEnforcer
    {
            ...
            int seed)
        {
            ...
            var placed = 0;
            CaveRouteMouthSnapUtility.ApplyMouthAnchoredPlacement(cavesRoot, geometry, layout, ground);
            ...
            CaveRouteMouthSnapUtility.TrySnapGeometryRouteStartToMouth(cavesRoot, geometry, layout, ground);
            ...
            CaveRouteMouthSnapUtility.TrySnapGeometryRouteStartToMouth(cavesRoot, geometry, layout, ground);
            CaveGroundPlacementUtility.TrySnapMouthToSurfaceDepthOnly(cavesRoot, ground, out _);
            CaveRouteMouthSnapUtility.FinalizeUndergroundEnvelope(cavesRoot, ground);
