...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    {
        public const int Total = 120;

        public const int Validate = 0;
        public const int GeoFirst = 1;
        public const int GeoCount = 13;
        public const int PlayabilityFirst = 14;
        public const int ValidationFirst = 32;
        public const int ValidationCount = 6;
        public const int GroundPolishFirst = 38;
        public const int GroundPolishCount = 10;
        public const int WorldFirst = 48;
        public const int WorldCount = 15;
        public const int Meat = 63;
        public const int PostMeatFirst = 64;
        public const int PostMeatCount = 24;
        public const int ResearchFirst = 88;
        public const int ResearchCount = 12;
        public const int FinalizePolishFirst = 100;
        public const int FinalizePolishCount = 18;
        public const int AaaManifest = 118;
        public const int FinishReport = 119;
        ...
        public static string GeoLabel(int step) => (step - GeoFirst + 1) switch
        {
            ...
            7 => "blocks — prepare",
            8 => "blocks — ring batch",
            9 => "blocks — wall details",
            10 => "features & goal",
            11 => "surface walk-in entrance",
            12 => "spawn & runtime",
            13 => "props, mobs & water",
            _ => "geometry",
        };
