    ...
    public static class SurfaceTerrainQualityGrader
    {
            ...
            Transform surfaceRoot)
        {
                ...
                SurfaceTerrainBuildLadder.TryTakeCachedGradedReport(seed, out var cached))
            {
                ...
                WriteQualityReport(cached, request);
            ...
            WriteQualityReport(report, request);
        ...
        public static void MirrorLadderReport(
            ...
            WorldGenerationRequest request = null)
        {
            ...
            sb.AppendLine($"  \"gradingTask\": \"{Escape(report.GradingTask)}\",");
            ...
            sb.AppendLine($"  \"stagePassScore\": {SurfaceTerrainBuildLadder.StagePassScore},");
            sb.AppendLine($"  \"stageFloorScore\": {SurfaceTerrainBuildLadder.StageFloorScore},");
            sb.AppendLine($"  \"expectedSurfaceTileCount\": {CaveBuildGradingProfile.ExpectedSurfaceTileCount(request)},");
            sb.AppendLine($"  \"minPlacedTileFraction\": {CaveBuildGradingProfile.MinPlacedTileFraction},");
