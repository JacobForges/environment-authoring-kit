...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveBuildAutonomousOrchestrator
    {
            ...
            Action onComplete)
        {
            ...
            {
                Debug.LogWarning(
                    "[CaveBuild] Autonomous loop skipped — " + CaveBuildCursorSettings.GraderCredentialHint());
                onComplete?.Invoke();
                return;
            }
            ...
            CaveBuildPipelineLog.Info(
                ...
                "Open Environment Kit Hub (Build tab) for live status.",
                "Autonomous");
        ...
        static void ScheduleAutonomousStep()
        {
            if (_state == State.Idle || _state == State.Done)
                return;
            ...
            CaveBuildActionPacing.ScheduleBuildStep(
                RunAutonomousStep,
                CaveBuildPipelineDomains.QueueLabel("autonomous loop"),
