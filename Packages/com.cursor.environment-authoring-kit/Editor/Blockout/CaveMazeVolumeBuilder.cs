...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveMazeVolumeBuilder
    {
            ...
            Material floorMat)
        {
            ...
            if (PipelineContentPreservePolicy.TryPreserveTransform(existing, RouteEndCavernRootName))
        ...
        public static int Build(Transform meshRoot, CaveMazeLayout layout, Material rockMat, bool adventureHybrid = false)
        {
            ...
            if (PipelineContentPreservePolicy.TryPreserveTransform(existing, MazeVolumeRootName))
                return existing.childCount;
