...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveBuildHeadlessRunner
    {
            ...
            bool exitEditorWhenDone = false)
        {
            ...
            if (exitEditorWhenDone || Application.isBatchMode)
            {
                CaveBuildPipelineWaiter.Begin(exitCodeOnSuccess: 0, exitCodeOnFailure: 1);
                return;
            }

            Debug.Log("[CaveBuild] Headless build queued — editor stays open until pipeline completes.");
        }
    }
}
#endif
