...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveAdventurePlayabilityPipeline
    {
        ...
        public static void RunStep(int step, Transform caveRoot, WorldGenerationRequest request, SceneGroundInfo ground)
        {
            ...
            RunStepBody(step, caveRoot, request, ground);
        }

        static void RunStepBody(int step, Transform caveRoot, WorldGenerationRequest request, SceneGroundInfo ground)
        {
        ...
        public static void QueueAutoFix(Transform caveRoot, System.Action onComplete)
        {
            if (caveRoot == null)
            {
                onComplete?.Invoke();
            ...
            CaveBuildActionPacing.ScheduleLight(
                ...
                CaveBuildPipelineDomains.QueueLabel("cave playability — auto fix"));
        }
