...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveAdventureShellBuilder
    {
        ...
        public static int Build(Transform meshRoot, CaveMazeLayout layout, Material rockMat, Material floorMat)
        {
            ...
            if (PipelineContentPreservePolicy.TryPreserveTransform(existing, ShellRootName))
                return existing.childCount;
            ...
            if (PipelineContentPreservePolicy.TryPreserveTransform(existingMaze, CaveMazeVolumeBuilder.MazeVolumeRootName))
                return existingMaze.childCount;
