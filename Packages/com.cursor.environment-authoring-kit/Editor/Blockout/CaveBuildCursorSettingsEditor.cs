...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    sealed class CaveBuildCursorSettingsEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space(8);
            EditorGUILayout.LabelField("3D Gaussian Splat", EditorStyles.boldLabel);
            EditorGUILayout.HelpBox(
                "Optional hero splat at primary cave mouth. Off by default. " +
                "See docs/GAUSSIAN_SPLAT_INTEGRATION.md. MacBook budget disables splats.",
                MessageType.None);
