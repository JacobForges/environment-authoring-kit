    ...
    public static class CaveEntranceVolumeBuilder
    {
            ...
            System.Random rng)
        {
            ...
            if (ground != null && ground.HasAnchor && cavesRoot != null)
            {
                ...
                var mouthRouteHoriz = Vector2.Distance(
                    new Vector2(topWorld.x, topWorld.z),
                    new Vector2(routeFloorWorld.x, routeFloorWorld.z));
                if (mouthRouteHoriz > 1.25f)
                {
                    bottomWorld = new Vector3(topWorld.x, routeFloorWorld.y, topWorld.z);
                }
