...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveWaterMaterialFactory
    {
        ...
        public static Material GetOrCreateLava()
        {
            ...
            var lavaTex = AssetDatabase.LoadAssetAtPath<Texture2D>(
                "Assets/EnvironmentKit/CC0Imports/Textures/lava_seamless.png");
            if (lavaTex != null && mat.HasProperty("_BaseMap"))
            {
                mat.SetTexture("_BaseMap", lavaTex);
