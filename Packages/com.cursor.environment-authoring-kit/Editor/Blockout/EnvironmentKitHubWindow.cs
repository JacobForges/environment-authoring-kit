    ...
    public sealed class EnvironmentKitHubWindow : EditorWindow
    {
        ...
        void DrawHeader()
        {
            ...
            EditorGUILayout.HelpBox(
                "Single place to run 122-step builds, tune settings, and inspect live generated data before export/prefab decisions.",
                MessageType.None);
        ...
        void DrawBuildTab()
        {
            ...
            {
                EditorGUILayout.HelpBox(
                    "Start here: Build Complete Cave (122). Works on a fresh empty scene with no API keys — " +
            ...
            {
                EditorGUILayout.BeginHorizontal();
                if (GUILayout.Button("Build Complete Cave (122)", GUILayout.Height(30f)))
