...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveBuildResearchConstrainedGate
    {
        ...
        static string[] DefaultAllowedIds(string rungId) => rungId switch
        {
            ...
            _ when rungId.StartsWith("mountain_") || rungId == "outer_ring_mountains" => new[]
            {
                "eth-procedural-mountains-glacial-landforms",
                "guerrilla-horizon-zero-dawn-terrain-mountain-streaming",
                "ubisoft-large-scale-terrain-authoring-open-worlds",
                "fromsoftware-elden-ring-verticality-cliff-edges",
            },
            _ => new[]
            {
                "world-gen-pipeline-ladder-best-practices",
