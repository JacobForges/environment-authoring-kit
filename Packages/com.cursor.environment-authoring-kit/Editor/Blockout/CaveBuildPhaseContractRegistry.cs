...
namespace EnvironmentAuthoringKit.Editor.Blockout
{
    ...
    public static class CaveBuildPhaseContractRegistry
    {
        ...
        public const string RungLayoutAuditPlayDisk = "layout_audit_play_disk";
        public const string RungLayoutAuditFoothillRing = "layout_audit_foothill_ring";
        public const string RungLayoutAuditWilderness = "layout_audit_wilderness";
        public const string RungTerrainContractCheck = "terrain_contract_check";
        ...
        static readonly RungContract[] Catalog =
        {
            ...
            new()
            {
                ...
                invalidates = new[]
                {
                    RungLayoutAuditPlayDisk,
                    RungLayoutAuditFoothillRing,
                    RungLayoutAuditWilderness,
                    RungTrailsNav,
                    RungSurfaceProps,
                    RungPreBuildGate,
                    RungCaveLayout,
            ...
            new()
            {
                id = RungLayoutAuditPlayDisk,
                title = "Layout audit — nine-tile play disk",
                inputs = new[] { "Terrain heightmap (9 tiles)" },
                outputs = new[] { CaveBuildWorldLayoutAudit.ReportRel },
                invalidates = new[] { RungLayoutAuditFoothillRing, RungPreBuildGate },
                maxRuntimeSecondsTarget = 10,
            },
            new()
            {
                id = RungLayoutAuditFoothillRing,
                title = "Layout audit — foothill ring",
                inputs = new[] { RungLayoutAuditPlayDisk, "foothill tiles" },
                outputs = new[] { CaveBuildWorldLayoutAudit.ReportRel },
                invalidates = new[] { RungLayoutAuditWilderness, RungPreBuildGate },
                maxRuntimeSecondsTarget = 10,
            },
            new()
            {
                id = RungLayoutAuditWilderness,
                title = "Layout audit — peak + wilderness",
                inputs = new[] { RungLayoutAuditFoothillRing, "peak tiles" },
                outputs = new[] { CaveBuildWorldLayoutAudit.ReportRel },
                invalidates = new[] { RungPreBuildGate },
                maxRuntimeSecondsTarget = 15,
            },
            new()
            {
                id = RungTerrainContractCheck,
                title = "Terrain artifact fingerprint check",
                inputs = new[] { CaveBuildTerrainFingerprint.StoreRel },
                outputs = new[] { CompletionRel },
                invalidates = Array.Empty<string>(),
                maxRuntimeSecondsTarget = 5,
            },
            new()
            {
