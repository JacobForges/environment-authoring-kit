...
export const TERRAIN_PIPELINE_PHASES: PipelinePhaseDef[] = [
  {
    ...
    researchCategories: ["fullworld_do_not", "terrain"],
  ...
  },
  {
    ...
    rung: "ground_placement",
    researchCategories: ["fullworld_do_not", "terrain", "ground_placement"],
  ...
  },
  {
    ...
    rung: "navmesh",
    researchCategories: ["fullworld_do_not", "ground_placement", "navmesh", "terrain_tiling"],
  ...
  },
  {
    ...
    forbidden: [
      "Props on vertical cliff normals (slope > 42°)",
      "Cliff ring around entire map",
      "Play-disk-only scatter (must cover all manifest terrains)",
      "BUILD/GENERATE/MAKE research database",
    ],
    webSearchQueries: [
    ...
    jsonPaths: [
      ...
      "Assets/EnvironmentKit/Generated/SurfaceTerrainBuildLadderReport.json",
      "Assets/EnvironmentKit/ResearchCache/categories/surface_props/index.json",
      "Assets/EnvironmentKit/ResearchCache/categories/prop_do_not/index.json",
    ],
    focus:
      "ONE task: per-tile prop scatter on every walkable terrain (81 tiles) — slope/normal gate; no props on vertical walls.",
  },
  {
