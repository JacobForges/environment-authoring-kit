...
export const MEAT_PASS_RESEARCH: MeatPassResearch[] = [
  ...
  { title: "Surface NavMesh + polish", researchFocus: "surface NavMesh, trails", categories: ["ground_placement", "navmesh"], entryIdPrefixes: ["unity6-"], surfaceTask: "surface_navmesh", webSearchQueries: ["Unity NavMesh terrain trails"] },
