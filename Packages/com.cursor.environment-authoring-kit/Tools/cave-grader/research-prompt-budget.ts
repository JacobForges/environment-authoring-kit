...
const TERRAIN_RUNG_KEYWORDS: Record<string, string[]> = {
  ...
  nine_tile_grid: ["terrain", "nine tile", "seam", "neighbor", "heightmap"],
  outer_ring_mountains: ["mountain", "outer ring", "perimeter", "cliff", "wilderness"],
  mountain_research: ["mountain", "MIT", "Harvard", "trail", "cliff", "Guerrilla", "Ubisoft"],
  mountain_lidar: ["lidar", "dem", "3dep", "hillshade", "elevation", "mountain"],
  mountain_cliffs: ["cliff", "fall edge", "ridge", "drop", "mountain"],
  mountain_trails: ["trail", "path", "bench", "hiking", "walkable", "grade"],
  mountain_play_smooth: ["smooth", "terrain", "trail", "play disk"],
};
...
export function researchAliasesForRung(rung: string): PromptRung[] {
  const terrain: Record<string, PromptRung[]> = {
    ...
    nine_tile_grid: ["ground_placement"],
    outer_ring_mountains: ["ground_placement", "research"],
    mountain_research: ["research", "ground_placement"],
    mountain_lidar: ["ground_placement"],
    mountain_cliffs: ["ground_placement"],
    mountain_trails: ["navmesh", "ground_placement"],
    mountain_play_smooth: ["ground_placement", "performance"],
  };
