...
import {
  ...
  MOUNTAIN_LABYRINTH_STYLE_EXAMPLES,
} from "./mountain-labyrinth-style-examples.js";
import { TERRAIN_TILING_PAPERS } from "./terrain-tiling-papers.js";
import { FULLWORLD_DO_NOT_PAPERS } from "./fullworld-do-not-papers.js";
import { FULLWORLD_LAYOUT_IDEAL_PAPERS } from "./fullworld-layout-ideal-papers.js";
import { FULLWORLD_GENERATION_STYLE_PAPERS } from "./fullworld-generation-style-papers.js";
import { LABYRINTH_IMPROPER_DO_NOT_PAPERS } from "./labyrinth-improper-do-not-papers.js";
import { TERRAIN_GENERATION_RESEARCH_ENTRIES } from "./terrain-generation-visual-references.js";
import { TERRAIN_PROP_RESEARCH_ENTRIES } from "./terrain-prop-visual-references.js";
import { SURFACE_PROP_PLACEMENT_PAPERS } from "./surface-prop-placement-papers.js";
import { PROP_DO_NOT_PAPERS } from "./prop-do-not-papers.js";
import { UNITY_EDITOR_AI_GUIDANCE_PAPERS } from "./unity-editor-ai-guidance-papers.js";
import { HOLLOW_TITAN_RESEARCH_PAPERS } from "./hollow-titan-research-papers.js";
import { HOLLOW_TITAN_DO_NOT_PAPERS } from "./hollow-titan-do-not-papers.js";
...
export function papersForMinYear(minYear = RESEARCH_MIN_YEAR): ResearchEntry[] {
  ...
  return [
    ...
    MOUNTAIN_LABYRINTH_DEFINITION,
    ...MOUNTAIN_LABYRINTH_STYLE_EXAMPLES,
    ...LABYRINTH_IMPROPER_DO_NOT_PAPERS,
    ...TERRAIN_TILING_PAPERS,
    ...FULLWORLD_DO_NOT_PAPERS,
    ...FULLWORLD_LAYOUT_IDEAL_PAPERS,
    ...FULLWORLD_GENERATION_STYLE_PAPERS,
    ...TERRAIN_GENERATION_RESEARCH_ENTRIES,
    ...SURFACE_PROP_PLACEMENT_PAPERS,
    ...PROP_DO_NOT_PAPERS,
    ...UNITY_EDITOR_AI_GUIDANCE_PAPERS,
    ...TERRAIN_PROP_RESEARCH_ENTRIES,
    ...HOLLOW_TITAN_RESEARCH_PAPERS,
    ...HOLLOW_TITAN_DO_NOT_PAPERS,
  ];
}
