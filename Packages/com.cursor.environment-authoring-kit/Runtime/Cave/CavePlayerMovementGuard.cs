...
namespace EnvironmentAuthoringKit.Cave
{
    ...
    public sealed class CavePlayerMovementGuard : MonoBehaviour
    {
        ...
        static void SetPlayerControllerFlags(Transform playerRoot, bool introActive, bool dialogActive)
        {
            ...
            if (controller != null)
            {
                controller.introActive = introActive;
                controller.dialogActive = dialogActive;
        ...
        static Transform ResolvePlayerRoot()
        {
            ...
            if (tagged != null && !IsNpcRoot(tagged))
        ...
        static bool IsNpcRoot(GameObject go) =>
            go.GetComponent<HollowTitanPatrolAgent>() != null ||
            go.GetComponent<HollowTitanFloorGuardBehavior>() != null ||
            go.GetComponent<CaveSpawnedEnemyAdapter>() != null ||
            (go.GetComponent<NavMeshAgent>() != null && go.GetComponent<PlayerController>() == null);
