...
namespace EnvironmentAuthoringKit.Cave
{
    ...
    public sealed class PlayerCameraRig : MonoBehaviour
    {
...
#if UNITY_EDITOR
            if (Application.isPlaying || !rig.TryAutoWireForEditor())
                rig.AutoWire();
#else
            rig.AutoWire();
#endif
        ...
        public void AutoWire()
        {
            ...
            DisableSceneMainCameraIfDifferent();
        }

        void DisableSceneMainCameraIfDifferent()
        {
            if (playerCamera == null)
                return;
        ...
        void BindPlayerControllerPivot()
        {
            ...
            if (controller != null && cameraPivot != null)
            {
