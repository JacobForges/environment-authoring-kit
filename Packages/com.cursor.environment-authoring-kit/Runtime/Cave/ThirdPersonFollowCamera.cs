...
namespace EnvironmentAuthoringKit.Cave
{
    ...
    public sealed class ThirdPersonFollowCamera : MonoBehaviour
    {
        ...
        public void SetFollowTarget(Transform followTarget, FollowMode followMode)
        {
            target = followTarget;
            mode = followMode;
            _targetController = followTarget != null ? followTarget.GetComponent<CharacterController>() : null;
