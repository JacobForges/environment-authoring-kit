...
| [PUBLIC_REPO_SCOPE.md](PUBLIC_REPO_SCOPE.md) | GitHub vs local machine — scenes, art, cache, secrets |
| [../REQUIREMENTS.md](../REQUIREMENTS.md) | Hub-level product requirements |
| [CHANGELOG.md](CHANGELOG.md) | Dated Hub / pipeline notes |
| [THIRD_PARTY_AND_LICENSE_SCOPE.md](THIRD_PARTY_AND_LICENSE_SCOPE.md) | CC0 vs Unity, Assets, npm, geodata |
| [../LICENSE](../LICENSE) | CC0 1.0 — original repo work the affirmer owns |
...
| Document | Content |
|----------|---------|
| [../Packages/com.cursor.environment-authoring-kit/README.md](../Packages/com.cursor.environment-authoring-kit/README.md) | Install, menus, **120-step** pipeline, Hub |
...
| [../Packages/com.cursor.environment-authoring-kit/CHANGELOG.md](../Packages/com.cursor.environment-authoring-kit/CHANGELOG.md) | Package version history (**0.3.0**) |
